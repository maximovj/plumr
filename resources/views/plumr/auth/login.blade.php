...
@section('main')
    <x-main class="m-0 h-screen flex items-center justify-center">
            <div class="w-full h-auto max-w-md border-2 p-14 shadow-sm rounded-lg">
                <form action="">
                    ...
                    <button class="bg-blue-600 hover:bg-blue-500 py-2 px-4 rounded-sm text-white text-sm">Iniciar
                        sesión</button>
                </form>
        </div>
    </x-main>
