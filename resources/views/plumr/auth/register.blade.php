...
@section('main')
<x-main>
    <div class="h-m-screen w-full lg:w-1/2 border-2 m-auto p-4 shadow-sm rounded-lg">
        ...
        <form action="">
            <section class="flex flex-col gap-2 mb-4">
                ...
                <input
                    ...
                    autocomplete="off"
                    autofocus
                    class="rounded-md p-2 border-1 border-gray-600 shadow-sm"
                />
                <p class="text-xs text-red-400 hidden">Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus ipsum sit laboriosam sint? In aliquid voluptates incidunt ad eveniet eum provident maiores eaque, reprehenderit beatae totam est neque, culpa nihil.</p>
            </section>
            ...
            <section class="flex flex-col gap-2 mb-4">
                ...
                <div class="grid grid-cols-3 gap-4">
                    ...
                    <input
                        ...
                        placeholder="Año"
                        name="birthday_year"
                        value="{{ old('birthday_year', (date('Y')-18)) }}"
                        min="{{ (date('Y')-100)  }}"
                        max="{{ date('Y') }}"
                        id="birthday"
                        autocomplete="off"
            ...
            <button
            class="bg-green-400 py-2 px-4 rounded-sm text-white text-sm"
            >Registrarme</button>
        </form>
    </div>
</x-main>
