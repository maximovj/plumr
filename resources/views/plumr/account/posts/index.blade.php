...
@section('main')
    <x-main>
        <section class="py-6 max-h-[90vh] overflow-y-auto">

            <!-- Encabezado -->
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4 px-4">
                <div class="flex flex-col gap-1">
                    <div class="text-sm text-gray-500 flex items-center gap-2">
                        <i class="bi bi-file-post-fill"></i>
                        <strong>{{ $posts->count() }}</strong> publicaciones
                    </div>
                ...
                <div>
                    @owner($user)
                        <h4 class="text-lg font-semibold text-gray-800">Mis publicaciones</h4>
                    @else
            ...
            <section class="px-4" style="max-height: 1134px; overflow-y: auto;">
                ...
                @else
                    <div
                        class="grid @owner($user) grid-cols-1 @else grid-cols-2 @endowner gap-4">
                            ...
                            <div class="bg-white shadow rounded-2xl p-6 mb-4">
                                ...
                                <div class="flex justify-between items-center mt-4 text-gray-500 text-sm">
                                    ...
                                    <div class="flex gap-4">
                                        <p class="flex items-center gap-1"><i class="bi bi-wechat"></i> <strong>0</strong>
                                            Discusiones</p>
                                        <p class="flex items-center gap-1"><i class="bi bi-1-square"></i> <strong>0</strong>
                                            Apoyo</p>
                                        <p class="flex items-center gap-1"><i class="bi bi-1-square"></i> <strong>0</strong>
                                            Difiero</p>
                                        <p class="flex items-center gap-1"><i class="bi bi-1-square"></i> <strong>0</strong>
