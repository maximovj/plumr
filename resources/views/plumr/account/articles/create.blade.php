    ...
    x-data="{ imagePreview: '{{ $article->cover_url ?? '' }}' }">
        ...
        <div class="flex flex-col md:flex-row gap-4">
            ...
            <section class="flex flex-col w-full md:w-1/2">
                ...
                <input type="text" name="author" id="author" value="{{ old('author') }}" placeholder="Ingresa autor del artículo" autocomplete="off" autofocus class="p-3 rounded-lg bg-blue-50 border border-gray-300
            ...
            <section class="flex flex-col w-full md:w-1/2">
                ...
                <input type="text" name="profession" id="profession" value="{{ old('profession') }}" placeholder="Ingresa un profesión para el artículo" autocomplete="off" class="p-3 rounded-lg bg-blue-50 border border-gray-300
        ...
        <div class="flex flex-col md:flex-row gap-4">
            ...
            <section class="flex flex-col w-full md:w-1/2">
                ...
                <input type="text" name="title" id="title" value="{{ old('title') }}" placeholder="Ingresa un título para el artículo" autocomplete="off" autofocus class="p-3 rounded-lg bg-blue-50 border border-gray-300
            ...
            <section class="flex flex-col w-full md:w-1/2">
                ...
                <input type="text" name="subtitle" id="subtitle" value="{{ old('subtitle') }}" placeholder="Ingresa un subtítulo para el artículo" autocomplete="off" class="p-3 rounded-lg bg-blue-50 border border-gray-300
        ...
        <section class="flex flex-col gap-1">
            ...
            <textarea name="summary" id="summary" placeholder="Ingresa un resumen del artículo" autocomplete="off" min="15" max="255" class="rounded-md p-2 shadow-sm bg-white border {{ e_class('summary') }}">{{ old('summary') }}</textarea>
            @error('summary')
        ...
        <div class="flex flex-col md:flex-row gap-4">
            ...
            <section class="flex flex-col w-full md:w-1/2">
                ...
                value="{{ old('cover') }}" placeholder="Ingresa fecha de publicación" autocomplete="off" class="p-3 rounded-lg bg-blue-50 border border-gray-300
        ...
        <div class="flex flex-col md:flex-row gap-4">
            ...
            <section class="flex flex-col w-full md:w-1/2">
                ...
                <input type="datetime-local" name="published_at" id="published_at" value="{{ old('published_at') }}" placeholder="Ingresa fecha de publicación" autocomplete="off" class="p-3 rounded-lg bg-blue-50 border border-gray-300
                       focus:outline-none focus:ring-2 focus:ring-green-400 shadow-sm {{ e_class('published_at') }}" />
                @error('published_at')
                <p class="text-red-500 text-xs my-2">{{ $message }}</p>
                @enderror
            </section>
            ...
            <section class="flex flex-col w-full md:w-1/2">
                ...
                <span class="text-xs text-gray-500">Escribe etiquetas separadas con comas(,)</span>
                <input type="text" name="tags" id="tags" value="{{ old('tags') }}" placeholder="Ingresa tus etiquetas" autocomplete="off" autofocus class="p-3 rounded-lg bg-blue-50 border border-gray-300
        ...
        <div class="flex flex-col md:flex-row gap-4">
            ...
            <section class="flex flex-col w-full md:w-1/2">
                ...
                <!-- Publico -->
                <div x-data="{ is_publish: false }" class="flex items-center space-x-2">
                    <!-- Label -->
                    ...
                    <button
                        type="button"
                        @click="is_publish = !is_publish"
                        :class="is_publish ? 'bg-green-500' : 'bg-gray-300'"
                        class="relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none"
                    >
                        <span
                            :class="is_publish ? 'translate-x-6' : 'translate-x-1'"
        ...
        <button type="submit" class=" bg-green-500 hover:bg-green-600 text-white font-semibold py-2 px-2 rounded-lg shadow transition">Crear artículo</button>
    </form>
